...
typedef enum
{
    ...
    IPC_SIGNAL_ID_VM_GET_FW_VERSION =                                        74,
    IPC_SIGNAL_ID_VM_GET_FW_VERSION_RSP =                                    75,
...
/**
 * DIR FROM_P1 Request P0 to send his firmware id
 */
typedef struct
{
    IPC_HEADER header; /**< id = \c IPC_SIGNAL_ID_VM_GET_FW_VERSION */
} IPC_VM_GET_FW_VERSION;

/**
 * DIR FROM_P0 Pass P0 firmware id for P1
 */
typedef struct
{
    IPC_HEADER header; /**< id = \c IPC_SIGNAL_ID_VM_GET_FW_VERSION_RSP */
    uint32 ret;
} IPC_VM_GET_FW_VERSION_RSP;

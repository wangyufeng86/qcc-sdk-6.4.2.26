...
/**
 * Abstraction for getting the bitserial rwb register.
 * \param i Bitserial instance.
 * \return Read/Write/Combo sequence identifier.
 */
uint16 hal_bitserial_rwb_get(bitserial_instance i);
...
/**
 * Abstraction for setting Bitserial inactive.
 * \param i Bitserial instance.
 * \param v "1" to force inactive, "0" to restore.
 */
void hal_bitserial_set_sel_inactive_set(bitserial_instance i, uint16 v);

...
/*
  The 'void *PanicNull(void *)' function can't be used for const pointers.
  So for those, this define will raise the general PANIC_APP_GENERIC instead.
*/
#define PanicConstNull(PTR) if (!(PTR)) Panic()

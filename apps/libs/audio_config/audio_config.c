...
typedef struct
{
    ...
    audio_opus_codec_capability_t   audio_opus_codec_capability;
} audio_config_t;
...
#define DEFAULT_OPUS_CODEC_CAPABILITY           audio_opus_codec_capability_16kbps
...
static audio_config_t audio_config =
{
    ...
    DEFAULT_OPUS_CODEC_CAPABILITY
};


void AudioConfigSetOpusCodecCapability(audio_opus_codec_capability_t  opus_codec_capability)
{
    audio_config.audio_opus_codec_capability = opus_codec_capability;
}

audio_opus_codec_capability_t AudioConfigGetOpusCodecCapability(void)
{
    return audio_config.audio_opus_codec_capability;
}

...
/*OPUS codec capability for 16KPBS or 32KPBS  */
typedef enum  {
    audio_opus_codec_capability_16kbps,
    audio_opus_codec_capability_32kbps
} audio_opus_codec_capability_t;
...
/*!
    @brief Set the OPUS codec capability (16KPBS  or 32 KBPS ).
*/
void AudioConfigSetOpusCodecCapability(audio_opus_codec_capability_t opus_codec_capability);
/*!
    @brief Get OPUS codec  capability (16KPBS or 32 KBPS ) set by application.
*/

...
static const operator_config_t spdif_ops[] =
{
    ...
    MAKE_OPERATOR_CONFIG(capability_id_iir_resampler, spdif_iir_resampler_role)
};
...
{
    {spdif_iir_resampler_role, spdif_output_left, 0},
    {spdif_iir_resampler_role, spdif_output_right, 1}
};

static const operator_connection_t spdif_connections[] =
{
    {spdif_decoder_role, 1, spdif_ttp_passthrough_role, 0, 2},
    {spdif_ttp_passthrough_role, 0, spdif_iir_resampler_role, 0, 2}
};

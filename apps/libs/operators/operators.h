...
typedef enum
{
    ...
    capability_id_opus_encoder                  = 0x4096,
...
/****************************************************************************
DESCRIPTION
    Set audio operators framework sample rate in Khz
*/
...
/****************************************************************************
DESCRIPTION
    Send a operator param message to enable sidetone path
 */
void OperatorsAecEnableSidetonePath(Operator op, bool enable);

/****************************************************************************
DESCRIPTION
    Send a operator param message to set sidetone gain
 */
...
/****************************************************************************
DESCRIPTION
    Send a message to the aec to enable input and output from same clock source
 */

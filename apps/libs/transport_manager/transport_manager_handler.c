...
static void transportMgrHandleConnectCfm(TRANSPORT_CONNECT_CFM_T * msg)
{
    ...
    if(transport_type != transport_mgr_type_gatt)
    {
        ...
        transportMgrUpdateSink(msg->transport_id, msg->sink,transportMgrConvertAdaptationType(msg->transport));
...
static void transportMgrHandleDisconnectCfm(TRANSPORT_DISCONNECT_CFM_T * msg)
{
    ...
    if(transport_type != transport_mgr_type_gatt)
    {
        ...
        transportMgrUpdateSink(msg->transport_id, NULL,transportMgrConvertAdaptationType(msg->transport));

...
/*!
 * @brief Gets the user modified processor ID for a given capability ID.
 *
 * @param cap_id The capability ID with which the processor ID is associated.
 * @param default_processor The processor ID associated with capability id by default.
 *
 * @return processor id on which user wants the capability to run.
 */

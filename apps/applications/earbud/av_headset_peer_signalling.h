...
typedef enum
{
    ...
    /*! Channel ID for ANC messages. */
    PEER_SIG_MSG_CHANNEL_ANC = 1UL << 2,

    /*! Channel ID for LEAKTHROUGH messages. */
    PEER_SIG_MSG_CHANNEL_LEAKTHROUGH = 1UL << 3,

    /*! Maximum channel ID */
    PEER_SIG_MSG_CHANNEL_MAX = 1UL << 4,

...
{
    kymeraTaskData *theKymera = appGetKymera();
    DEBUG_LOGF("appKymeraHandleInternalScoForwardingStopTx, state %u", appKymeraGetState());
    ...
    {   
        ...
        if (theKymera->sco_info->mic_fwd)
        {
            ...
            // Cancel configuration message from SCO FW Tx
            appScoFwdCancelNotifyIncomingMicSink();
        }

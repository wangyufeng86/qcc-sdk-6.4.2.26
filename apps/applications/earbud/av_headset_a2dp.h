    ...
    A2DP_STATE_CONNECTING_CROSSOVER                             = 0x04, /*!< Locally and remotely initiated connection is progress */
        ...
        A2DP_STATE_CONNECTING_MEDIA_REMOTE_SYNC                 = 0x12, /*!< Remotely initiated media channel connection in progress */
            A2DP_STATE_CONNECTED_MEDIA	                        = 0x30, /*!< Media channel connected (parent-pseudo state) */
                A2DP_STATE_CONNECTED_MEDIA_ROLE_SWITCH          = 0x31, /*!< Performing role-switch */
                A2DP_STATE_CONNECTED_MEDIA_STREAMING            = 0x32, /*!< Media channel streaming */
                A2DP_STATE_CONNECTED_MEDIA_STREAMING_MUTED      = 0x33, /*!< Media channel streaming but muted (suspend failed) */
                A2DP_STATE_CONNECTED_MEDIA_SUSPENDING_LOCAL     = 0x34, /*!< Locally initiated media channel suspend in progress */
                A2DP_STATE_CONNECTED_MEDIA_SUSPENDED	        = 0x35, /*!< Media channel suspended */
                A2DP_STATE_CONNECTED_MEDIA_RECONFIGURING        = 0x36, /*!< Media channel suspended, reconfiguring the codec */
...
typedef struct a2dpTaskData
{
    ...
    uint16          rs_lock;               /*!< A2DP operation role switch lock, used to block operations if role switch in progress */
...
#define appA2dpGetRoleSwitchLock(theInst) ((theInst)->a2dp.rs_lock)
...
#define APP_A2DP_ROLE_SWITCH_LOCK   1U
...
/*! \brief Set A2DP lock bit for role switch pending */
#define appA2dpSetRoleSwitchLockBit(theInst) (theInst)->a2dp.rs_lock |= APP_A2DP_ROLE_SWITCH_LOCK
/*! \brief Clear A2DP lock bit for role switch pending */
#define appA2dpClearRoleSwitchLockBit(theInst) (theInst)->a2dp.rs_lock &= ~APP_A2DP_ROLE_SWITCH_LOCK
...
extern void appA2dpNotifyRole(struct avInstanceTaskData *theInst, hci_role role);

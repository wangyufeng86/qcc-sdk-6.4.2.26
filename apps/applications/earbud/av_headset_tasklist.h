...
typedef struct
{
    ...
    /*! Size of data items, or 0 if no data. */
    uint8 data_size;
} TaskList;
 ...
 */
typedef bool (*TaskListIterateWithDataRawHandler)(Task task, void *data, void *arg);
...
/*! \brief Create a TaskList that can also store associated data.
    \param[in] data_size Size in octets of associated data per task.

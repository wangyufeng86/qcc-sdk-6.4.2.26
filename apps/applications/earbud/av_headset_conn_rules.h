...
enum    av_headset_conn_rules_messages
{
    ...
    /*! sync peer LEAKTHROUGH data. */
    CONN_RULES_PEER_SYNC_LEAKTHROUGH_DATA,
    /*! sync peer ANC data. */
    CONN_RULES_PEER_SYNC_ANC_DATA,
    ...
    /*! Update of peer link status */
    CONN_RULES_PEER_LINK_STATUS,

    /*! Disable the AEC leakthrough */
    CONN_RULES_AEC_LEAKTHROUGH_DISABLE,
...
/*! \brief Definition of CONN_RULES_PEER_LINK_STATUS message. */
typedef struct
{
    lpEbInCase in_case:2;       /* In case state of both Earbuds */
    lpEbStreaming streaming:2;  /* One or both Earbuds are streaming */
} CONN_RULES_PEER_LINK_STATUS_T;

...
/*!
 *
 * \brief Set ANC Enable, Disable, toggle State in Earbud device
 */
...
/*!
 *
 * \brief Set and get ANC Modes(ucid 0,1,2) in Earbud device
 */
...
/*!
 *
 * \brief Set and get ANC fine Gain(0-255 range) in Earbud device
 */
